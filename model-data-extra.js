...
Object.assign(MODEL_DETAILS, {
  ...
  "jet-max": {
    colors: [
      ...
      { name: "Azul", hex: "#1e5b94", images: [
        "modelos/jet-max/azul/jet-max-azul-1.jpg",
        "modelos/jet-max/azul/jet-max-azul-2.jpg",
        "modelos/jet-max/azul/jet-max-azul-3.jpg",
        "modelos/jet-max/azul/jet-max-azul-4.jpg",
        "modelos/jet-max/azul/jet-max-azul-5.jpg",
        "modelos/jet-max/azul/jet-max-azul-6.jpg",
        "modelos/jet-max/azul/jet-max-azul-7.jpg",
      ] },
      ...
      { name: "Prateado", hex: "#6b6b6b", images: [
        ...
        "modelos/jet-max/silvered/jet-max-silvered-4.jpg",
        "modelos/jet-max/silvered/jet-max-silvered-5.jpg",
        "modelos/jet-max/silvered/jet-max-silvered-6.jpg",
        "modelos/jet-max/silvered/jet-max-silvered-7.jpg",
      ] },
    ],
    gallery: [
